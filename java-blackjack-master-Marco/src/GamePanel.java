...
public class GamePanel extends JPanel implements ActionListener {
    ...
    private JButton newGameButton = new JButton("Chamar");
    private JButton hitButton = new JButton("Bater");
    private JButton doubleButton = new JButton("Dobro");
    private JButton standButton = new JButton("Manter");
    private JButton clearDeck = new JButton("Limpar Deck");
    ...
    private JLabel currentBet = new JLabel("Por favor, defina sua aposta...");
    private JLabel playerWallet = new JLabel("$999.99");
    private JLabel cardsLeft = new JLabel("Cartas faltando...");
    private JLabel dealerSays = new JLabel("Dealer fala...");
    ...
    public GamePanel() {
        ...
        clearDeck.addActionListener(this);
        ...
        // tool tips
        newGameButton.setToolTipText("Faça um novo jogo.");
        hitButton.setToolTipText("Solicite outra carta.");
        doubleButton.setToolTipText("Duplique a sua aposta e receba outra carta.");
        standButton.setToolTipText("Fique com sua mão de cartas.");
        clearBet.setToolTipText("Limpe sua aposta atual.");
        add1Chip.setToolTipText("Adicione uma ficha de $1 à sua aposta atual.");
        add5Chip.setToolTipText("Adicione uma ficha de $5 à sua aposta atual");
        add10Chip.setToolTipText("Adicione uma ficha de $10 à sua aposta atual");
        add25Chip.setToolTipText("Adicione uma ficha de $25 à sua aposta atual");
        add100Chip.setToolTipText("Adicione uma ficha de $100 à sua aposta atual");

        dealer = new Dealer();
        player = new Player("Marco", 32, "Homem");
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        if (act.equals("Chamar")) {
            ...
            System.out.println("Aposta limpa");
            clearBet();
        } else if (act.equals("Limpar Deck")) {
            dealer.newDeck();
        }
    ...
    private void moreFunds() {
        int response = JOptionPane.showConfirmDialog(null, "Ajuda!!!. Mão de $1000 Dollars.", "Sem fundos",
    ...
    public void savePlayer() {
        if (dealer.isGameOver()) {
            ...
            JOptionPane.showMessageDialog(this, "Não é possível salvar um jogador enquanto um jogo está em andamento.",
    ...
    public void openPlayer() {
        if (dealer.isGameOver()) {
            ...
            JOptionPane.showMessageDialog(this,
                    "Não é possível abrir um jogador existente enquanto um jogo está em andamento.", "Error",
                    JOptionPane.ERROR_MESSAGE);
        }
    }

    public void updatePlayer() {
        PlayerDialog playerDetails = new PlayerDialog(null, "Deatalhes do Jogador", true, player);
