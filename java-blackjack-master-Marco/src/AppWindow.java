    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        switch (act) {
            ...
            case "Dar as cartas":
                gamePanel.newGame();
                break;
            case "Comprar uma carta":
                gamePanel.hit();
                break;
            case "Dobrar aposta":
                gamePanel.playDouble();
                break;
            case "Mostrar as cartas":
                gamePanel.stand();
                break;
            case "Atualizar detalhes do perfil":
                gamePanel.updatePlayer();
                break;
            case "Salvar perfil atual":
                gamePanel.savePlayer();
                break;
            case "Mudar a cor da mesa":
